...
98 tests pass. No assistant message has been sent from this side at any point, because a real DeepSeek key is configured and each call costs money — the tool layer is exercised directly instead, which is also why the batched-tool-call bug survived until a human actually talked to it.
