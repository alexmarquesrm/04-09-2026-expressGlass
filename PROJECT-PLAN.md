...
- User accounts (`users` table, session or JWT auth) — **S3, not yet built**
- Task assignment (`assignee_id` on `tasks`, referencing `users`) — **S4, not yet built**
- Board-level permissions (owner/member roles per board) — **S5, not yet built**
